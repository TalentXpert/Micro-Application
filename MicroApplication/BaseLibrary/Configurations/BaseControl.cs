namespace BaseLibrary.Configurations
{
    ...
    public abstract class BaseControl
    {
        ...
        public static AppControl UploadFile => AppControl.CreateSystemControl("F3C4B63C-3824-4454-9684-FC2C50217CEC", BaseControls.UploadFile, "UploadFile", ControlDataType.String, ControlTypes.UploadFile);
    }
}
