...
namespace MicroAppAPI.Configurations
{
    ...
    public class ApplicationPage : BasePage
    {
        ...
        public const string AssetGroupPageId = "E16CE3BB-E1DF-C02B-2C7F-08D906558D58";
        public static AppPage AssetGroupPage = AppPage.Create(AssetGroupPageId, "Asset Group", ApplicationMenu.AssetConfigurationId, 1, ApplicationPermission.ManageAssetGroup);

        public const string AssetSubgroupPageId = "9A4F5DD3-2B70-C47C-2982-08D9087650C4";
        public static AppPage AssetSubgroupPage = AppPage.Create(AssetSubgroupPageId, "Asset Subgroup", ApplicationMenu.AssetConfigurationId, 2, ApplicationPermission.ManageAssetSubgroup);

        public const string AssetPageId = "41C55263-D9E0-CD72-96AC-08D90656C39A";
        public static AppPage AssetPage = AppPage.Create(AssetPageId, "Asset", ApplicationMenu.AssetConfigurationId, 3, ApplicationPermission.ManageAsset);


        public const string CountryPageId = "D5D696BD-018D-CB71-D097-08D906190B63";
        public static AppPage CountryPage = AppPage.Create(CountryPageId, "Country", BaseMenu.ConfigurationMenuId, 1, ApplicationPermission.ManageCountry);

        public const string StatePageId = "CBE9797F-D8F8-C3EA-23D4-08D906551EF1";
        public static AppPage StatePage = AppPage.Create(StatePageId, "State", BaseMenu.ConfigurationMenuId, 2, ApplicationPermission.ManageState);

        public const string CityPageId = "A7046401-9ADA-CD5D-4FCB-08D9065541C8";
        public static AppPage CityPage = AppPage.Create(CityPageId, "City", BaseMenu.ConfigurationMenuId, 3, ApplicationPermission.ManageCity);


        protected override List<AppPage> GetApplicationPages()
        {
            return new List<AppPage> { CountryPage, StatePage, CityPage, AssetGroupPage, AssetSubgroupPage, AssetPage, ApplicationControlPage, UserManagementPage };
        }
    }
...
52173B32-B3A8-C227-EC5A-08D9089FBAB5
2CF53ADD-9AB4-C0BD-A327-08D908A67D22
D387B73D-45AC-C116-A741-08D909447A8A
F9873BA4-FE58-C3A8-FFE7-08D90949354F
545A4CBB-6A62-C1C3-97E0-08D90A27551F
C8AFE5D7-1833-C61B-BBF9-08D90AD67EE2
89A8306F-9D30-C831-D552-08D90AD67EE2
C9BCF025-B0C1-C81E-D6D2-08D90AD67EE2
52BFE4D8-86A8-C3F5-D7A8-08D90AD67EE2
401EE374-69DF-CCC1-D86F-08D90AD67EE2
6FD218A1-C307-C3D9-D941-08D90AD67EE2
1CA7B808-34D8-C0C5-DA76-08D90AD67EE2
48C84F3D-7BC4-C6AB-41FE-08D90BC55171
CF84521B-246B-C6ED-54B2-08D90BC55171
48EC0D29-41F0-CC3A-5505-08D90BC55171
